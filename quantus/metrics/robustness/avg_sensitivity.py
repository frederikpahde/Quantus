...
class AvgSensitivity(BatchedPerturbationMetric):
    ...
    def evaluate_batch(
        ...
        for step_id in range(self.nr_samples):
            ...
            #     explain_func_kwargs_copied['question'] = np.expand_dims(explain_func_kwargs_copied['question'], 0)
            #     explain_func_kwargs_copied['q_length'] = np.expand_dims(explain_func_kwargs_copied['q_length'], 0)
